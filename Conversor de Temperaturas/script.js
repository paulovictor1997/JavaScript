function confirmar(){
    ...
    if(temp[0].checked){
        ...
        if(temperatura == 'De Celsius para Fahrenheint'){
           num = 1.8 * num + 32
           resultado.innerHTML = `${temperatura} a conversão de ${numero.value}Cº é : ${num} Fº`
        }
        }
        if(temp[1].checked){
            ...
            if(temperatura =='De Fahrenheint para Celsius'){
               num = (num - 32) * 5/9
               resultado.innerHTML = `${temperatura} a conversão de ${numero.value}Fº é : ${num} Cº`
            }
        }
        if(temp[2].checked){
            ...
            if(temperatura == 'De Kelvin para Celsius'){
                num = num - 273
                resultado.innerHTML = `${temperatura} a conversão de ${numero.value}Kº é : ${num} Cº`
            }
        }
        if(temp[3].checked){
            ...
            if(temperatura ==  'De Celsius para Kelvin' ){
                num = num + 273
                resultado.innerHTML = `${temperatura}a conversão de ${numero.value}Cº fica : ${num} Kº` 
            }
        }
        if(temp[4].checked){
            ...
            if(temperatura == 'De Fahrenheint para Kelvin'){
                num = (num -32) * 5/9 + 273
                resultado.innerHTML = `${temperatura}a conversão de ${numero.value}Fº fica : ${num} Kº`
        ...
        if(temp[5].checked){
            ...
            if(temperatura == 'De Kelvin para Fahrenheint'){
                num = (num - 273) * 9/5 + 32
                resultado.innerHTML = `${temperatura} a conversão de ${numero.value}Kº fica :${num} Fº`
            }
        }
