let personagemContador = document.getElementById('personagem');
let planetaContador = document.getElementById('planeta');
let luaContador = document.getElementById('lua');
let naveContador = document.getElementById('nave');
...
async function preencherTabela(){
  let response = await swapiGet('films/');
  let tableData = response.data.results;
